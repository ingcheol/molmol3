...
<head>
    <meta charset="UTF-8">
    <title>Bottom - 깔롱드</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css">
</head>
<body>

<div class="container mt-5">
    <h2 class="text-center mb-4">👖 하의 상품 리스트</h2>
            ...
            <div class="col">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body text-center">
                        ...
                        <a href="/product/see?productId=${p.productId}&prevPage=bottom" class="btn btn-outline-primary btn-sm">상세 보기</a>
