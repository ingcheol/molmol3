...
<style>
    ...
    /* 예외 이미지: collection-log.jpg 전용 */
    .special-holder {
        height: auto !important;         /* 이미지 박스 높이 제한 해제 */
        overflow: visible !important;    /* 잘린 부분 보여주기 */
    }

    .special-holder .special-img {
        height: auto !important;         /* 이미지 자체도 원본 비율 유지 */
            ...
            <div class="collection-item d-flex flex-wrap my-5">
                <div class="col-md-6 column-container">
                    <div class="image-holder special-holder">
                        <img src="image/collection-log.jpg" class="product-image special-img">
                    </div>
