...
## 🎯 주제
> [연애인 착용 이미지 기반의 상품 조회 및 구매 웹 사이트 ]
...
- 상품 상세 보기: 상품 이미지, 가격, 수량 선택 및 장바구니 담기 가능
...
- 장바구니 /주문 목록 페이지: 각각  /cart, /pages/orders를 통해 접근 가능
...
![ERD](src/main/resources/static/image/fashion.png)
